...
export const Route = createFileRoute("/search")({
  head: () => ({
    meta: [
      { title: "Search | Zariya House" },
      { name: "description", content: "Search jewellery designs, collections and stories at Zariya House." },
        ...
        {collections.length > 0 && (
          <div className="mb-12">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {collections.map((c) => (
                <Link key={c.slug} to="/collections/$slug" params={{ slug: c.slug }} className="group flex items-center gap-4 border border-border p-4 hover:border-gold">
