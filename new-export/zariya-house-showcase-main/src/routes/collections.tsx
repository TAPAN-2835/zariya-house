...
export const Route = createFileRoute("/collections")({
  head: () => ({
    meta: [
      { title: "Collections | Zariya House" },
      { name: "description", content: "Editorial jewellery collections — bridal, everyday, temple heritage, modern minimal, men's signature and more." },
      { property: "og:title", content: "Collections | Zariya House" },
