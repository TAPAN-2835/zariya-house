...
export const Route = createFileRoute("/craftsmanship")({
  head: () => ({
    meta: [
      { title: "Craftsmanship | Zariya House" },
      { name: "description", content: "The craft, materials and hands behind every Zariya House piece — from pencil sketch to final polish." },
      { property: "og:title", content: "Craftsmanship — Zariya House" },
